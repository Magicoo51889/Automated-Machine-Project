...
def print_ticket(surname, num_adults, num_child, num_senior, num_students, num_wristbands):
...
print_ticket(surname, num_adults, num_child, num_senior, num_students, num_wristbands)
